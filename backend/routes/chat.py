...
def chat(req: ChatRequest):
    ...
    system_prompt = (
        ...
        "- Have a meaningful conversation of 3-5 exchanges before summarizing.\n"
        ...
        "EARLY SUMMARY TRIGGER:\n"
        "- If the user explicitly asks you to summarize, generate, or indicates readiness "
        "(e.g. 'just give the prompt', 'make the song', 'I'm ready', 'let's do it', 'generate'), "
        "produce the summary IMMEDIATELY regardless of exchange count.\n\n"
        "WHEN READY TO SUMMARIZE (after 3+ exchanges, or when user explicitly asks):\n"
